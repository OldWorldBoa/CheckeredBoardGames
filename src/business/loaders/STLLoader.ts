import { BufferGeometry, Loader, LoadingManager, LoaderUtils, Vector3, Float32BufferAttribute, BufferAttribute, FileLoader } from 'three';

// This is the threejs STLLoader converted to typescript so mocha can run properly
...
private isBinary(data: ArrayBuffer) {
	...
	private parseBinary(data: ArrayBuffer) {
			...
			var defaultR: number = 0,
			    defaultG: number = 0,
			    defaultB: number = 0, alpha;
