...
import BoardFactory from '../../../src/business/BoardFactory';
...
describe('ChessMediator tests', () => {
	it('moves board pieces', () => {
		let mediator = new ChessMediator(new MockBoardFactory(), new MovementJudgeAlwaysTrue());
	...
	it('moves board pieces track first move', () => {
		let mediator = new ChessMediator(new MockBoardFactory(), new MovementJudgeFirstMoveTrueNextMovesFalse());
...
class MockBoardFactory implements BoardFactory {
